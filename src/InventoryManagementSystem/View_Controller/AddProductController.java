...
/**
 * The AddProductController is responsible for simulating a user interface that allows a user to add a Product to the
 * Inventory.
 *
 * @author Henry Trieu
 */
public class AddProductController implements Initializable {
    ...
    // Loads the Parts from the inventory to the top table for referencing Parts
    @Override
    ...
    private void onActionSaveBtn() throws IOException
    {
        ...
        // if there are no exceptions, add the product to the inventory and switch to the main screen
        else
        {
